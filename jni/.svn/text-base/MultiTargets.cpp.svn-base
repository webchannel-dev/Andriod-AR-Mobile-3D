...
static const float kBowlScaleX    = 180.0f * 0.15f;
static const float kBowlScaleY    = 180.0f * 0.15f;
static const float kBowlScaleZ    = 180.0f * 0.15f;
...
Java_msc_ar_sound3d_MultiTargets_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargets_onQCARInitializedNative(JNIEnv *, jobject)
{
    LOG("Java_msc_ar_sound3d_MultiTargets_onQCARInitializedNative");
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargetsRenderer_initNativeCallback(JNIEnv* env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargetsRenderer_renderFrame(JNIEnv *, jobject)
{

    //LOG("Java_msc_ar_sound3d_GLRenderer_renderFrame");
    ...
    if (state.getNumActiveTrackables())
    {
        ...
        SampleUtils::translatePoseMatrix(0.0f, -0.50f*120.0f, 1.35f*120.0f,
                                         &modelViewMatrix.data[0]);
        SampleUtils::rotatePoseMatrix(-90.0f, 0, 0, 1,
                                      &modelViewMatrix.data[0]);
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargets_initApplicationNative(JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_msc_ar_sound3d_MultiTargets_initApplicationNative");
    ...
    jmethodID getTextureMethodID = env->GetMethodID(activityClass,
        "getTexture", "(I)Lmsc/ar/sound3d/Texture;");
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargets_deinitApplicationNative(JNIEnv* env, jobject obj)
{
    LOG("Java_msc_ar_sound3d_MultiTargets_deinitApplicationNative");
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargets_startCamera(JNIEnv *,jobject)
{
    LOG("Java_msc_ar_sound3d_MultiTargets_startCamera");
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargets_stopCamera(JNIEnv *,jobject)
{
    LOG("Java_msc_ar_sound3d_MultiTargets_stopCamera");
...
Java_msc_ar_sound3d_MultiTargets_toggleFlash(JNIEnv*, jobject, jboolean flash)
{
    return QCAR::CameraDevice::getInstance().setFlashTorchMode((flash==JNI_TRUE)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_msc_ar_sound3d_MultiTargets_autofocus(JNIEnv*, jobject)
{
    return QCAR::CameraDevice::getInstance().startAutoFocus()?JNI_TRUE:JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_msc_ar_sound3d_MultiTargets_setFocusMode(JNIEnv*, jobject, jint mode)
{
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargetsRenderer_initRendering(JNIEnv* env, jobject obj)
{
    LOG("Java_msc_ar_sound3d_MultiTargetsRenderer_initRendering");
...
JNIEXPORT void JNICALL
Java_msc_ar_sound3d_MultiTargetsRenderer_updateRendering(JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_msc_ar_sound3d_MultiTargetsRenderer_updateRendering");
...
initMIT()
{
    ...
    const char* names[6]   = { "FlakeBox.Front","FlakeBox.Back" ,"FlakeBox.Left","FlakeBox.Right","FlakeBox.Top","FlakeBox.Bottom"};
    ...
    if(mit==NULL)
    {
        ...
        mit = QCAR::MultiTarget::create("front");
